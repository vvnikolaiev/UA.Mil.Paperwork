...
{
    internal class EngineeringAmmunitionResidualPriceCalculator : DefaultResidualPriceCalculator
    {
        public override IList<string> GetColumnHeaders() =>
            [ResidualValueReportStrings.CoeffStorage,
             ResidualValueReportStrings.CoeffStoragePeriod,
             ResidualValueReportStrings.CoeffQuality];
