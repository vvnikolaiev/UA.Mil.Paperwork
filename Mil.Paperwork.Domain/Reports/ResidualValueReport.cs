...
namespace Mil.Paperwork.Domain.Reports
{
    internal partial class ResidualValueReport : IResidualValueReport
    {
        ...
        // todo: move most of it to the helper.
        ...
        private static void FillTheTable(WriteOffReportData reportData, ExcelWorksheet sheet)
        {
            ...
            for (int i = 0; i < assets.Count; i++)
            {
                ...
                sheet.Cells[newRow, ResidualValueReportHelper.TABLE_COLUMN_INDEXATION_COEFF].Value = CoefficientsHelper.GetIndexationCoefficient(asset.StartDate, reportData.WriteOffDate);
                sheet.Cells[newRow, ResidualValueReportHelper.TABLE_COLUMN_CURRENCY_CONVERSION_RATE].Value = "-";
                sheet.Cells[newRow, ResidualValueReportHelper.TABLE_COLUMN_COEFF_E].Value = CoefficientsHelper.GetExploitationCoefficient(asset.StartDate, reportData.WriteOffDate);
