    ...
    internal class QualityStateReport : IReport
    {
        ...
        private static void FillTheTable(WriteOffReportData reportData, Table table)
        {
            ...
            for (int i = 0; i < reportData.Assets.Count; i++)
            {
                ...
                var residualPrice = ResidualPriceHelper.CalculateResidualPriceForItem(asset, reportData.WriteOffDate);
                ...
                var monthsOperated = (int)((reportData.WriteOffDate - asset.StartDate).TotalDays / 30);
        ...
        private static void AddSummaryRow(WriteOffReportData reportData, Table table)
        {
            ...
            var totalSumText = ReportHelper.ConvertTotalSumToUkrainianString((decimal)totalSum);
